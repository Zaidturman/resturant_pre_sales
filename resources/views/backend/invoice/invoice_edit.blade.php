                                ...
                                <div class="col-md-12">
                                    <form method="POST" action="{{ route('invoices.update', $invoice->id) }}">
                                        ...
                                        <div class="invoice-details">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="payment_method" id="payment_method" class="form-select">
                                                        <option value="نقدي شيكل"
                                                            {{ $invoice->payment_method == 'نقدي شيكل' ? 'selected' : '' }}>
                                                            نقدي شيكل</option>
                                                        <option value="نقدي دينار"
                                                            {{ $invoice->payment_method == 'نقدي دينار' ? 'selected' : '' }}>
                                                            نقدي دينار</option>
                                                        <option value="شيك"
                                                            {{ $invoice->payment_method == 'شيك' ? 'selected' : '' }}>شيك
                                                        </option>
                                                        <option value="حوالة بنكية"
                                                            {{ $invoice->payment_method == 'حوالة بنكية' ? 'selected' : '' }}>
                                                            حوالة بنكية</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" name="discount_amount" id="discount_amount"
                                                        class="form-control" value="{{ $invoice->discount_amount }}"
                                                        min="0" step="0.01">
                                                </div>
                                            </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody id="invoiceItems">
                                                    @foreach ($invoice->invoice_details as $item)
                                                        <tr>
                                                            <input type="hidden" name="existing_details[]"
                                                                value="{{ $item->id }}">
                                                            ...
                                                            <td>
                                                                <input type="number" name="selling_qty[]"
                                                                    class="form-control selling_qty"
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    <button type="button" class="btn btn-primary" id="addRow">إضافة
                                                        منتج</button>
                                                </div>
                                                <div class="col-md-6 text-end">
                                                    <h4>الإجمالي: <span
                                                            id="estimated_amount">{{ $invoice->payment->total_amount + $invoice->discount_amount }}</span>
                                                        ₪</h4>
                                                    <input type="hidden" name="estimated_amount"
                                                        id="estimated_amount_input"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="paid_status" id="paid_status" class="form-select">
                                                        <option value="full_paid"
                                                            {{ $invoice->payment->paid_status == 'full_paid' ? 'selected' : '' }}>
                                                            مدفوع بالكامل</option>
                                                        <option value="partial_paid"
                                                            {{ $invoice->payment->paid_status == 'partial_paid' ? 'selected' : '' }}>
                                                            دفع جزئي</option>
                                                        <option value="full_due"
                                                            {{ $invoice->payment->paid_status == 'full_due' ? 'selected' : '' }}>
                                                            دين كامل</option>
                                                    </select>
                                                    <input type="number" name="paid_amount"
                                                        class="form-control paid_amount mt-2"
