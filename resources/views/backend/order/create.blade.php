            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h4 class="card-title">إنشاء طلبة جديدة</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('order.store') }}" id="order-form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">رقم الطلبة</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">تاريخ الطلبة</label>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    ...
                                    <button type="button" class="btn btn-sm btn-success mt-2" id="add-product">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-save"></i> حفظ الطلبة
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-md-4 mb-3 product-item" 
                        ...
                        <div class="card h-100 border-0 shadow-sm product-card">
                            <div class="card-body text-center">
                                ...
                                <p class="text-success fw-bold">{{ number_format($product->selling_price ?? $product->price ?? 0, 2) }} شيكل</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
$(document).ready(function() {
    ...
    $('.product-item').hover(
        function() { $(this).find('.product-card').addClass('border-success'); },
        function() { $(this).find('.product-card').removeClass('border-success'); }
    );
